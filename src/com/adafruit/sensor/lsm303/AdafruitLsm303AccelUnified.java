...
import com.adafruit.sensor.SensorType;
import com.adafruit.sensor.SensorVector;
...
public class AdafruitLsm303AccelUnified extends AdafruitLsm303Unified
{
	...
	public SensorEvent getEvent()
	{
		...
		float x = _accelData.getX() * _lsm303Accel_MG_LSB * SENSORS_GRAVITY_STANDARD;
		float y = _accelData.getY() * _lsm303Accel_MG_LSB * SENSORS_GRAVITY_STANDARD;
		float z = _accelData.getZ() * _lsm303Accel_MG_LSB * SENSORS_GRAVITY_STANDARD;
		SensorEvent event = new SensorEvent(getSensorID(), SensorType.SENSOR_TYPE_ACCELEROMETER, mills(), new SensorVector(x, y, z));
	}

	public Sensor getSensor()
	{
		return new Sensor("LSM303", 1, getSensorID(), SensorType.SENSOR_TYPE_ACCELEROMETER, 0, 0.0f, 0.0f, 0.0f, 0);
	}
